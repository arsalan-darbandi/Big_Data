...
Master’s Hard disk capacity is depended on your data but for number of processor, it is better you give 2 processor cores and for memory more than 4GB which I give 8GB(Fig.1) while you can leave configuration of slaves as default.<img align="center" width="500px" src="https://github.com/asikhalaban/Big_Data/blob/master/img/Fig.1.png?raw=true">
